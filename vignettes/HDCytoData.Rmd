...
author: 
  ...
  - name: Charlotte Soneson
    affiliation: 
      - *id1 "Friedrich Miescher Institute for Biomedical Research, Basel, Switzerland"
      - *id2 "SIB Swiss Institute of Bioinformatics, Basel, Switzerland"
package: HDCytoData
output: 
...
Currently, the package contains the following datasets, which can be grouped into datasets useful for benchmarking either clustering algorithms or methods for differential analysis:
...
First, we show how to load the datasets, using one of the datasets (`Bodenmiller_BCR_XL`) as an example.
