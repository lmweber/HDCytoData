...
df_Weber_BCR_XL_sim_main_SE <- cbind(
  ...
  Description = paste0(
    "Semi-simulated mass cytometry (CyTOF) dataset from Weber et al. (2019), ", 
    "constructed by randomly splitting unstimulated (reference) samples into two halves, and ", 
    "replacing B cells in one half with stimulated (BCR-XL) B cells from corresponding paired samples. ", 
    "Main simulation. ", 
    "This dataset can be used to benchmark differential analysis algorithms used to test for ", 
